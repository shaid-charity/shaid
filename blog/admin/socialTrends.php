      ...
      <form id=form2 method = "post" >
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-append">
              <button type = "add_key" name="add_key" id="add_key" class="btn btn-primary mr-2">Add Keyword </button>
            </span>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-append">
              <button type = "del_key" name="del_key" id="del_key" class="btn btn-danger mr-2">Delete Keyword </button>
            </span>
          </div>
        </div>
      </form>
